...
function render(){
  ...
  for(const a of assignments){
    ...
    appendChecks(item,a,definition);appendMechanics(item,a,definition);appendHazardGuidance(item,a,definition);appendEncounterGuidance(item,a,definition);appendLootGuidance(item,a,definition);appendOutcomeHistory(item,a);
