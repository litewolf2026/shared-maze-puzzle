...
console.log(`selem-scenes: ${authoredIds.length}/${sceneNodes.length} scene locations authored; ${sparseNodes.length} transit locations remain outside the authored scene layer`);
