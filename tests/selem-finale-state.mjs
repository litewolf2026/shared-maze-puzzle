...
assert.equal(pack.version,5,'Canonical Selem fauna should advance the scenario content pack to v5.');
...
console.log('selem-finale-state: OK (legacy finale state remains compatible with scenario pack v5; cleanup is a separate scope)');
