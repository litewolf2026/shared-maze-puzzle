...
for(const marker of ['crawler-ritual-dais','crawler-projected-pillar','crawler-stalactite','crawler-terrain-deep_water','data-room'])assert.ok(renderer.includes(marker),`Renderer lost ${marker}.`);
