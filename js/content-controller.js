...
function render(){
  ...
  for(const a of assignments){
    ...
    appendChecks(item,a,definition);appendMechanics(item,a,definition);appendOutcomeHistory(item,a);
